...
local opt = lapp[[
    ...
    -d,--loaddir        (default "caffe")       subdirectory to load nets
...
--
if opt.full then
   nbTrainingPatches = 4000
   nbTestingPatches = 384
else
   nbTrainingPatches = 192
   nbTestingPatches = 32
...
ds_dir = './database'
ds_trset = paths.concat(ds_dir, 'trainC.t7')
ds_teset = paths.concat(ds_dir, 'testC.t7')
